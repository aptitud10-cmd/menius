-- ============================================================
-- Smart Suggestions: Co-occurrence RPC + Manual Pairings Table
-- ============================================================

-- 1. Manual product pairings configured by restaurant owners
...
-- ============================================================
-- 2. Co-occurrence RPC
--    Returns top products most frequently ordered together with
--    a given product, constrained to the same restaurant.
-- ============================================================
...
SECURITY DEFINER
AS $$
  -- Find orders that contain the anchor product, then count how many of
  -- those orders also contained every other product.
  SELECT
    oi2.product_id,
  ...
  JOIN orders       o    ON o.id = oi1.order_id
                        ...
                        -- Only use completed orders for meaningful signal
