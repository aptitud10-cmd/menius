    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://fonts.googleapis.com https://maps.googleapis.com https://client.crisp.chat https://us-assets.i.posthog.com https://api.mapbox.com",
      ...
      },
      {
        ...
        headers: [
          // Align with app/[slug]/page.tsx revalidate=300 — fewer origin hits, faster repeat views at the edge
