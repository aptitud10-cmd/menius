...
const ITEMS = {
  ...
  'fried-plantains-tostones': {
    ...
    plate: `a natural pile of flat round tostones filling the centre of the plate. NOTHING else on the plate — NO ramekin, NO sauce, NO dip, NO ketchup.`,
    styling: `These are GREEN PLANTAIN, not potato: each piece is a flat disc about 6cm across and 1.5cm thick, smashed flat after the first fry so the edges are rough, cracked and irregular, showing the plantain's straight longitudinal fibres. They have been fried TWICE and are DEEP GOLDEN-BROWN and glossy all over — richly fried, crisp and well coloured, NOT pale, NOT beige, NOT raw-looking, NOT baked. The surface is crunchy and blistered with darker caramelised edges, only the very centre of each disc staying lighter. Visible salt crystals.`,
    lighting: HARD, aperture: 'f/4.0 — the whole pile in sharp focus' },
