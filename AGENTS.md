...
> Detalles extendidos (schema DB, env vars, clientes, crons, dev tool, stack extra) viven en memorias on-demand en `~/.Codex/projects/c--Users-willi-menius/memory/`. Pedime lo que necesites.
