...
export function WelcomeQRModal({ slug, restaurantName, locale = 'es' }: WelcomeQRModalProps) {
  ...
  const shareWhatsApp = () => {
    const text = encodeURIComponent(
      locale === 'en'
        ? `Check out our digital menu! Order directly from your phone:\n${menuUrl}`
        : `¡Mira nuestro menú digital! Pide directamente desde tu celular:\n${menuUrl}`
    );
      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="px-6 pt-4 pb-6 space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#25D366] hover:bg-[#20b857] text-white font-semibold text-sm transition-colors"
          >
