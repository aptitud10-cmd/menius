          ...
          {step === 'upload' && (
            <div className="space-y-6">
              <div
                ...
                className="relative border-2 border-dashed border-gray-200 rounded-2xl p-10 text-center hover:border-brand-300 hover:bg-brand-50/30 transition-colors cursor-pointer"
                onClick={() => fileRef.current?.click()}
              >
                {loading ? (
                  <div className="flex flex-col items-center gap-3">
                    <Loader2 className="w-10 h-10 text-brand-500 animate-spin" />
                    <p className="text-sm text-gray-600 font-medium">Analizando menú con IA...</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button onClick={() => toggleAll(true)} className="text-xs text-brand-600 font-medium hover:text-brand-700">
                    Seleccionar todos
                  </button>
                      ...
                      return (
                        ...
                        >
                          <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center flex-shrink-0 transition-colors ${
                            item.selected ? 'bg-brand-500 border-brand-500' : 'border-gray-300'
                          }`}>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
          {step === 'review' && (
            <>
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-brand-500 text-white font-semibold text-sm disabled:opacity-40 disabled:cursor-not-allowed hover:bg-brand-600 transition-colors flex items-center gap-2"
              >
          ...
          {step === 'done' && (
            <button
              ...
              className="ml-auto px-6 py-2.5 rounded-xl bg-brand-500 text-white font-semibold text-sm hover:bg-brand-600 transition-colors"
            >
              Ver productos
            </button>
          )}
