...
const mockMenu = [
  ...
  { name: 'Burrito Supreme', desc: 'Carne, frijol, queso', price: '$15.99', popular: false },
  { name: 'Horchata', desc: 'Bebida artesanal', price: '$4.00', popular: false },
];
  ...
  return (
    <LazyMotion features={domAnimation}>
      <section className="relative min-h-[100vh] min-h-[100dvh] flex items-center overflow-clip">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-6 w-full py-24 md:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              >
                ...
                <span className="text-sm md:text-[13px] text-gray-300 md:text-gray-400 tracking-wide">
              ...
              <m.h1
                ...
                className="text-[2.5rem] sm:text-[3.5rem] lg:text-[4.5rem] font-semibold leading-[0.92] tracking-[-0.04em] text-white"
              >
                Menú digital y{' '}
              ...
              <m.p
                ...
                className="mt-5 md:mt-7 text-[17px] sm:text-lg text-gray-300 max-w-[480px] mx-auto lg:mx-0 leading-relaxed font-light"
              >
              ...
              <m.div
                ...
                className="mt-7 md:mt-9 flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3"
              >
                <Link
                  href="/signup"
                  className="group w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white text-black font-semibold text-[15px] hover:bg-gray-100 transition-all text-center btn-glow"
                >
                ...
                <Link
                  href="/r/demo"
                  className="w-full sm:w-auto px-8 py-3.5 rounded-2xl border border-white/10 text-gray-200 font-semibold text-[15px] hover:text-white hover:border-white/20 hover:bg-white/[0.03] transition-all text-center"
                >
                  Ver demo en vivo
                </Link>
              </m.div>
              ...
              <m.div
                ...
                className="mt-10 md:mt-14 flex items-center justify-center lg:justify-start gap-8 sm:gap-12"
              >
                {[
                  { target: 0, suffix: '%', label: 'Comisiones' },
                  { target: 14, suffix: ' días', label: 'Prueba gratis' },
                  { target: 2, suffix: ' min', label: 'Configuración' },
                ].map((s) => (
                  <div key={s.label} className="text-center lg:text-left">
                    ...
                    <p className="text-xs md:text-[13px] text-gray-400 mt-1.5 font-medium">{s.label}</p>
                  </div>
                ))}
              </m.div>
            </div>
              ...
              >
                <div className="relative w-[280px] h-[580px] rounded-[2.5rem] border-[3px] border-white/[0.12] bg-gray-950 shadow-[0_0_80px_rgba(120,80,255,0.15),0_25px_50px_rgba(0,0,0,0.5)] overflow-hidden">
                  ...
                  <div className="relative z-10 px-4 pb-4">
                      ...
                      {['Popular', 'Tacos', 'Bebidas', 'Postres'].map((cat, i) => (
                        <span
                          ...
                          className={`px-2.5 py-1 rounded-full text-[9px] font-medium flex-shrink-0 ${
                            i === 0 ? 'bg-white text-black' : 'bg-white/[0.06] text-gray-400'
                          }`}
                        >
                          {cat}
                        </span>
                    ...
                    <div className="space-y-2">
                      {mockMenu.map((item, i) => (
                        <m.div
                          ...
                          className="flex items-center gap-2.5 p-2 rounded-xl bg-white/[0.03] border border-white/[0.05]"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5">
                              ...
                              {item.popular && (
                                <span className="px-1 py-0.5 rounded bg-amber-500/20 text-amber-300 text-[7px] font-bold flex-shrink-0">★</span>
                              )}
                            </div>
                    ...
                    >
                      <span className="text-black text-[10px] font-semibold">🛒 Ver carrito · $41.48</span>
                    </m.div>
                    ...
                    <m.div
                      ...
                      className="mt-2 p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-2"
                    >
