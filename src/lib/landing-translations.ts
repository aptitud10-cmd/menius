...
const es = {
  ...
  hero: {
    badge: 'Sin comisiones · Sin contrato · Cancela cuando quieras',
    titleLine1: 'Vende directo. ',
    titleHighlight: 'Quédate con todo.',
    productLine: 'Sin la comisión de las apps de delivery.',
    subtitle: 'Tu menú con QR, pedidos online y pagos directos a tu cuenta. Las apps de delivery se quedan con hasta el 30% de cada pedido. Con MENIUS: 0%. Funciona en la tablet o el celular que ya tienes.',
    subtitleShort: 'Pedidos online con 0% de comisión. En la tablet que ya tienes.',
    ctaPrimary: 'Prueba 14 días gratis',
    ctaSecondary: 'Calcula tu ahorro',
    stats: [
      { value: '0%', label: 'Comisión por pedido' },
      { value: 'hasta 30%', label: 'Que se quedan las apps' },
    ...
    plans: [
      {
        ...
        cta: 'Elegir Starter',
        features: ['Menú digital con fotos', 'QR para hasta 15 mesas', 'Pedidos (dine-in + pickup + delivery)', 'Sin marca MENIUS en el menú', 'MENIUS AI (asistente IA)', 'Importar menú desde foto (IA)', 'Analytics completo (histórico completo)', '2 usuarios administradores', 'Pagos online (0% comisión)', 'Soporte por chat (8h)'],
      },
      {
        name: 'Pro',
        price: 79,
        ...
        cta: 'Elegir Pro',
        features: ['Todo de Starter', 'Hasta 50 mesas', 'Notificaciones por email', 'Cocina KDS en tiempo real', 'Promociones y cupones', 'Reseñas de clientes', 'Programa de lealtad para clientes', '5 usuarios', 'Exportar reportes PDF / CSV', 'Soporte por chat (2h)'],
      },
      {
        name: 'Business',
        price: 149,
        ...
        cta: 'Elegir Business',
        features: ['Todo de Pro', 'Mesas y usuarios ilimitados', 'Hasta 3 sucursales incluidas', 'Dominio personalizado', 'Exportar datos CSV / Excel', 'Acceso API', 'Onboarding 1:1 con el equipo MENIUS', 'Account manager (chat)', 'Soporte prioritario (respuesta < 1h)'],
      },
    ],
    planComparison: {
      sectionLabel: 'Comparar planes',
      sectionTitle: 'Todo en un vistazo',
      sectionDesc: 'Elige el plan que se adapta al tamaño de tu negocio.',
      colFree: 'Gratis',
      colStarter: 'Starter',
      colPro: 'Pro',
      ...
      perMonth: '/mes',
      rows: [
        { feature: 'Mesas', free: '5', starter: '15', pro: '50', business: 'Ilimitadas' },
        { feature: 'Dine-in', free: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Pickup', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Delivery', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Pagos online', free: '—', starter: '0% comisión', pro: '0% comisión', business: '0% comisión' },
        { feature: 'MENIUS AI', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Sin marca MENIUS', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Analytics', free: '—', starter: 'Completo', pro: 'Completo', business: 'Completo' },
        { feature: 'KDS cocina', free: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Promociones', free: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Loyalty', free: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Usuarios admin', free: '1', starter: '2', pro: '5', business: 'Ilimitados' },
        { feature: 'Sucursales', free: '1', starter: '1', pro: '1', business: '3' },
        { feature: 'Soporte', free: 'Email 48h', starter: 'Chat 8h', pro: 'Chat 2h', business: '< 1h' },
      ],
    },
...
const en: LandingT = {
  ...
  hero: {
    badge: 'No commission · No contract · Cancel anytime',
    titleLine1: 'Take orders online. ',
    titleHighlight: 'Keep every dollar.',
    productLine: 'No delivery-app commission.',
    subtitle: 'QR menu, real-time orders, and AI that builds your menu from a photo. Payments go straight to your account. Delivery apps take up to 30% of every order — MENIUS takes 0%. Runs on the tablet or phone you already have.',
    subtitleShort: 'Online orders with 0% commission. On the tablet you already have.',
    ctaPrimary: 'Start your 14-day trial',
    ctaSecondary: 'Calculate your savings',
    stats: [
      { value: '0%', label: 'Commission per order' },
      { value: 'up to 30%', label: 'What delivery apps take' },
    ...
    plans: [
      {
        ...
        cta: 'Get Starter',
        features: ['Digital menu with photos', 'QR codes up to 15 tables', 'Orders (dine-in + pickup + delivery)', 'No MENIUS branding', 'MENIUS AI assistant', 'Import menu from photo (AI)', 'Full analytics (complete history)', '2 admin users', 'Online payments (0% commission)', 'Chat support (8h)'],
      },
      {
        name: 'Pro',
        price: 79,
        ...
        cta: 'Get Pro',
        features: ['Everything in Starter', 'Up to 50 tables', 'Email notifications', 'Real-time kitchen KDS', 'Promotions & coupons', 'Customer reviews', 'Customer loyalty program', '5 users', 'Export reports PDF / CSV', 'Chat support (2h)'],
      },
      {
        name: 'Business',
        price: 149,
        ...
        cta: 'Get Business',
        features: ['Everything in Pro', 'Unlimited tables & users', 'Up to 3 locations included', 'Custom domain', 'Full data export (CSV / Excel)', 'API access', '1:1 onboarding with the MENIUS team', 'Dedicated account manager (chat)', 'Priority support (response < 1h)'],
      },
    ],
    planComparison: {
      sectionLabel: 'Compare plans',
      sectionTitle: 'Everything at a glance',
      sectionDesc: 'Choose the plan that fits your business size.',
      colFree: 'Free',
      colStarter: 'Starter',
      colPro: 'Pro',
      colBusiness: 'Business',
      perMonth: '/mo',
      rows: [
        { feature: 'Tables', free: '5', starter: '15', pro: '50', business: 'Unlimited' },
        { feature: 'Dine-in', free: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Pickup', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Delivery', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Online payments', free: '—', starter: '0% commission', pro: '0% commission', business: '0% commission' },
        { feature: 'MENIUS AI', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'No MENIUS branding', free: '—', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Analytics', free: '—', starter: 'Full', pro: 'Full', business: 'Full' },
        { feature: 'Kitchen KDS', free: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Promotions', free: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Loyalty', free: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Admin users', free: '1', starter: '2', pro: '5', business: 'Unlimited' },
        { feature: 'Locations', free: '1', starter: '1', pro: '1', business: '3' },
        { feature: 'Support', free: 'Email 48h', starter: 'Chat 8h', pro: 'Chat 2h', business: '< 1h' },
      ],
    },
