...
const es = {
  ...
  hero: {
    ...
    subtitle: 'Tus clientes ordenan desde el celular. Tú cobras directo. Sin Rappi. Sin comisiones. Listo en 2 minutos.',
...
const en: LandingT = {
  ...
  hero: {
    ...
    subtitle: 'Your customers order from their phone. You collect directly. No delivery apps. No commissions. Ready in 2 minutes.',
