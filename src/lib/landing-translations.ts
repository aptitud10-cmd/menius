...
const es = {
  ...
  pricing: {
    ...
    commissionPlan: {
      ...
      name: 'Paga al crecer',
      subtitle: '$0/mes',
      desc: 'Activa pagos online sin cuota mensual. Solo pagas cuando tus clientes pagan con tarjeta.',
      note: '~7% total (4% MENIUS + 2.9% Stripe) vs 25–30% de Rappi o Uber Eats',
      breakeven: 'Equivale a Starter en $975/mes de ventas online',
      calcLabel: '¿Cuánto vendés online por mes? $',
      calcPlaceholder: '0',
      calcResult: 'le pagarías a MENIUS (4% de comisión)',
      calcComparison: 'vs ~25% con otras plataformas',
      calcUpsell: 'Considera Starter $39/mes y ahorra',
      cta: 'Activar — sin cuota mensual →',
    ...
    planComparison: {
      ...
      rows: [
        ...
        { feature: 'Pickup', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Delivery', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Pagos online', free: '—', commission: '~7% total', starter: '0% comisión', pro: '0% comisión', business: '0% comisión' },
        { feature: 'MENIUS AI', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Sin marca MENIUS', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Analytics', free: '—', commission: 'Completo', starter: 'Completo', pro: 'Completo', business: 'Completo' },
        { feature: 'KDS cocina', free: '—', commission: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Promociones', free: '—', commission: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Loyalty', free: '—', commission: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Usuarios admin', free: '1', commission: '2', starter: '2', pro: '5', business: 'Ilimitados' },
        { feature: 'Sucursales', free: '1', commission: '1', starter: '1', pro: '1', business: '3' },
        { feature: 'Soporte', free: 'Email 48h', commission: 'Chat 8h', starter: 'Chat 8h', pro: 'Chat 2h', business: '< 1h' },
      ],
    },
...
const en: LandingT = {
  ...
  pricing: {
    ...
    commissionPlan: {
      ...
      subtitle: '$0/mo',
      desc: 'Enable online payments with no monthly fee. Pay only when your customers pay by card.',
      note: '~7% total (4% MENIUS + 2.9% Stripe) vs 25–30% on Rappi or Uber Eats',
      breakeven: 'Equals Starter plan at $975/mo in online sales',
      calcLabel: 'How much do you sell online per month? $',
      calcPlaceholder: '0',
      calcResult: 'you\'d pay MENIUS (4% commission)',
      calcComparison: 'vs ~25% with other platforms',
      calcUpsell: 'Consider Starter $39/mo and save',
      cta: 'Activate — no monthly fee →',
    ...
    planComparison: {
      ...
      rows: [
        ...
        { feature: 'Pickup', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Delivery', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Online payments', free: '—', commission: '~7% total', starter: '0% commission', pro: '0% commission', business: '0% commission' },
        { feature: 'MENIUS AI', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'No MENIUS branding', free: '—', commission: '✓', starter: '✓', pro: '✓', business: '✓' },
        { feature: 'Analytics', free: '—', commission: 'Full', starter: 'Full', pro: 'Full', business: 'Full' },
        { feature: 'Kitchen KDS', free: '—', commission: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Promotions', free: '—', commission: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Loyalty', free: '—', commission: '—', starter: '—', pro: '✓', business: '✓' },
        { feature: 'Admin users', free: '1', commission: '2', starter: '2', pro: '5', business: 'Unlimited' },
        { feature: 'Locations', free: '1', commission: '1', starter: '1', pro: '1', business: '3' },
        { feature: 'Support', free: 'Email 48h', commission: 'Chat 8h', starter: 'Chat 8h', pro: 'Chat 2h', business: '< 1h' },
      ],
    },
