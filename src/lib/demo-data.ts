...
export const demoProducts: Product[] = [
  // ── Desayunos ──
  {
    ...
    price: 9.99, image_url: 'https://images.unsplash.com/photo-1534352956036-cd81e27dd615?w=600&h=400&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 8.99, image_url: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 7.49, image_url: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 6.99, image_url: 'https://images.unsplash.com/photo-1517673400267-0251440c45dc?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 13.99, image_url: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 2, created_at: older, variants: [], extras: [],
  },
  {
  ...
  },
  {
    ...
    price: 12.99, image_url: 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 15.99, image_url: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 14.99, image_url: 'https://images.unsplash.com/photo-1534352956036-cd81e27dd615?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 4, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 8.99, image_url: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 5, created_at: older, dietary_tags: ['vegetarian', 'gluten_free'], variants: [], extras: [],
  },
  {
    ...
    price: 9.99, image_url: 'https://images.unsplash.com/photo-1618040996337-56904b7850b9?w=600&h=340&fit=crop&q=80',
  ...
  // ── Aperitivos ──
  {
    ...
    price: 8.50, image_url: 'https://images.unsplash.com/photo-1615870216519-2f9fa575fa5c?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 12.99, image_url: 'https://images.unsplash.com/photo-1535399831218-d5bd36d1a6b3?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 11.99, image_url: 'https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 3, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 7.99, image_url: 'https://images.unsplash.com/photo-1601924582970-9238bcb495d9?w=600&h=400&fit=crop&q=80',
    is_active: true, sort_order: 4, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 6.99, image_url: 'https://images.unsplash.com/photo-1639024471283-03518883512d?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 12.99, image_url: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=600&h=400&fit=crop&q=80',
  ...
  // ── Bebidas ──
  {
    ...
    price: 3.99, image_url: 'https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 3.49, image_url: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 2, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 4.00, image_url: 'https://images.unsplash.com/photo-1541658016709-82535e94bc69?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 3, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 5.49, image_url: 'https://images.unsplash.com/photo-1622597467836-f3285f2131b8?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 4, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 2.99, image_url: 'https://images.unsplash.com/photo-1581636625402-29b2a704ef13?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 5, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 2.49, image_url: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 6, created_at: older, variants: [], extras: [],
  },
  ...
  },
  {
    ...
    price: 9.99, image_url: 'https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 3, created_at: older, variants: [], extras: [],
  },
  {
  ...
  },
  {
    ...
    price: 7.49, image_url: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 6, created_at: older, variants: [], extras: [],
  },
  ...
  // ── Tortas (Postres) ──
  {
    ...
    price: 6.99, image_url: 'https://images.unsplash.com/photo-1528975604071-b4dc52a2d18c?w=600&h=340&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 7.49, image_url: 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=600&h=400&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 8.49, image_url: 'https://images.unsplash.com/photo-1464305795204-6f5bbfc7fb81?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 3, created_at: older, variants: [], extras: [],
  },
  {
  ...
  },
  {
    ...
    price: 5.99, image_url: 'https://images.unsplash.com/photo-1501443762994-82bd5dace89a?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 5, created_at: older, variants: [], extras: [],
  },
  {
    ...
    price: 7.99, image_url: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=600&h=340&fit=crop&q=80',
    is_active: true, sort_order: 6, created_at: older, variants: [], extras: [],
  },
];
