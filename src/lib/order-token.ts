 ...
 *
 * If neither secret is set the check is skipped (permissive fallback so existing
 * deployments keep working until the env var is added).
 */
 ...
 * - Returns true when SECRET is not configured (permissive mode).
