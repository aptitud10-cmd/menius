...
const es: DashboardTranslations = {
  ...
  counter_hub_installStep1:
    "En la tablet Android, abre Chrome y ve al link de descarga del APK.",
  counter_hub_installStep2:
    'Si Android pregunta "¿Instalar de fuente desconocida?", acepta. Es seguro.',
  counter_hub_installStep3: "Una vez instalada, abre la app MENIUS Counter.",
  counter_hub_installStep4:
    "Inicia sesión con tu cuenta de MENIUS. La app se conecta automáticamente a tus órdenes.",
  ...
  counter_hub_scanQrDesc:
    "Apunta la cámara de tu tablet Android al código QR para descargar la app.",
  ...
  home_trialEnjoy:
    "Estás probando el plan Starter gratis. Al terminar, pasarás al plan Free sin cobros.",
  home_trialDowngradeNote:
    "Sin suscripción, continuarás en el plan Free (gratis para siempre).",
  ...
  home_upsellDesc:
    "Estás en el plan gratuito. Acepta delivery, pickup y pagos online con un plan de pago.",
  ...
  orders_emptyDesc:
    "Comparte tu menú QR con tus clientes para empezar a recibir pedidos en tiempo real.",
  ...
  kds_busyModeDesc:
    "Agrega minutos extra de preparación sin detener los pedidos.",
  ...
  tables_noTablesDesc:
    "Crea mesas para generar códigos QR personalizados que tus clientes escanean para pedir.",
  ...
  tables_generalQRDesc:
    "Comparte este QR en redes sociales, stickers, tarjetas, flyers",
  ...
  editor_categoryNote:
    'Los productos de esta categoría aparecen bajo "{name}" en el menú.',
  editor_aiLabel: "IA",
  ...
  categories_deleteConfirm:
    "¿Eliminar esta categoría? Se eliminarán también todos los productos asociados.",
  ...
  chat_errorLimit:
    "Has alcanzado el límite de mensajes. Intenta en unos minutos.",
  ...
  settings_bannerDesc:
    "Imagen de portada que aparece en la parte superior de tu menú público.",
  ...
  settings_additionalLanguagesDesc:
    "Agrega idiomas para que tus clientes puedan ver el menú en su idioma.",
  settings_primary: "principal",
  settings_addLanguage: "Agregar",
  settings_addLanguageSelect: "Agregar idioma...",
  settings_languageSelectorNote:
  ...
  settings_stripeConnectDesc:
    "Conecta tu cuenta de Stripe para aceptar pagos en línea.",
  ...
  settings_notificationsDesc:
    "Recibe notificaciones cuando tengas nuevos pedidos.",
  ...
  settings_scheduleDesc:
    "Configura el horario en que tu restaurante está abierto.",
  ...
  settings_bannerFormatNote:
    "Medida ideal: 1200 x 400px (3:1). JPG, PNG o WebP, máximo 10MB.",
  settings_dineInDesc: "El cliente ordena y come en tu restaurante",
  settings_pickupDesc: "El cliente ordena y pasa a recoger",
  settings_deliveryDesc:
    "El cliente pone su dirección y tú le envías el pedido",
  settings_deliveryFeeNote:
  ...
  settings_onlinePaymentDesc:
    "El cliente paga con tarjeta al ordenar (requiere Stripe Connect)",
  ...
  settings_emailNotificationDesc:
    "Los clientes que dejen su email recibirán confirmaciones y actualizaciones de su pedido.",
  settings_notificationsOffDesc:
    "Las notificaciones están desactivadas. Actívalas para recibir alertas de nuevas órdenes.",
  ...
  // Onboarding
  onboarding_title: "Últimos pasos para empezar",
  onboarding_stepsOf: "de",
  onboarding_allComplete: "¡Ya puedes recibir pedidos!",
  onboarding_allCompleteDesc:
    "Tu menú digital está listo. Comparte tu QR y empieza a vender.",
  onboarding_uploadLogo: "Pon el logo de tu restaurante",
  onboarding_uploadLogoDesc: "Tu logo aparece en el menú que ven tus clientes",
  onboarding_completeProfile: "Agrega tu teléfono y dirección",
  onboarding_completeProfileDesc: "Los clientes te encuentran más fácil",
  onboarding_setSchedule: "Pon tus horarios de apertura",
  onboarding_setScheduleDesc: "Los clientes sabrán a qué hora pueden pedir",
  onboarding_customizeMenu: "Agrega tus platillos y precios",
  onboarding_customizeMenuDesc:
    "Entre más platillos, más ventas. Agrega fotos también.",
  onboarding_generateQR: "Crea los QR de tus mesas",
  onboarding_generateQRDesc:
    "Imprímelos y ponlos en cada mesa para que los clientes pidan solos",
  onboarding_firstOrder: "Recibe tu primer pedido",
  onboarding_firstOrderDesc:
    "Comparte tu menú con un cliente y recibe tu primer orden",
  onboarding_openCounter: "Abre la pantalla de pedidos",
  onboarding_openCounterDesc:
    "Desde aquí ves y gestionas todos tus pedidos en tiempo real",
  onboarding_configurePrinter: "Conecta tu impresora de tickets",
  onboarding_configurePrinterDesc:
    "Imprime automáticamente cada nuevo pedido en tu cocina",
  ...
  onboarding_previewMenu: "Ver cómo se ve tu menú",
  ...
  reviews_noReviewsDesc:
    "Las reseñas aparecerán cuando tus clientes califiquen sus pedidos.",
  ...
  customers_empty:
    "Aún no hay clientes. Se crean automáticamente con cada pedido.",
  ...
  customers_notesPlaceholder:
    "Alergias, preferencias, notas sobre este cliente...",
  ...
  marketing_subtitle:
    "Campañas de email, redes sociales, SMS y automatizaciones con IA",
  ...
  email_aiDesc:
    "La IA creará asunto, mensaje y CTA optimizados basados en tu restaurante y audiencia.",
  ...
  email_variablesHint:
    "Usa {nombre} para personalizar con el nombre del cliente, {restaurante} para tu restaurante",
  email_msgVariablesHint:
    "Variables: {nombre}, {total_ordenes}, {total_gastado}, {restaurante}",
  ...
  sms_serviceDesc:
    "Para enviar SMS se requiere un proveedor como Twilio o MessageBird. Configura tus credenciales en las variables de entorno. Costo aproximado: $0.01-0.05 USD por SMS según el país.",
  ...
  auto_infoText:
    "Las automatizaciones se ejecutan diariamente a las 10:00 UTC mediante un cron job de Vercel. Los emails en tiempo real (confirmación de pedido, alertas) se envían al instante cuando ocurre el evento. Para activar/desactivar automatizaciones, ve a <strong>Ajustes → Notificaciones</strong>.",
  ...
  auto_orderConfirmDesc:
    "Envía confirmación automática al cliente cuando realiza un pedido con su email.",
  auto_orderConfirmTrigger: "Cada nuevo pedido",
  auto_orderStatusTitle: "Actualización de estado",
  auto_orderStatusDesc:
    "Notifica al cliente cuando su pedido cambia de estado (confirmado, preparando, listo, entregado).",
  auto_orderStatusTrigger: "Cambio de estado del pedido",
  auto_ownerAlertTitle: "Alerta de nuevo pedido (dueño)",
  auto_ownerAlertDesc:
    "Envía notificación al dueño del restaurante cada vez que llega un nuevo pedido.",
  auto_welcomeTitle: "Bienvenida a nuevos clientes",
  auto_welcomeDesc:
    "Email automático de bienvenida a clientes que hacen su primer pedido.",
  auto_reactivationTitle: "Reactivación de inactivos",
  auto_reactivationDesc:
    "Invita a regresar a clientes que no han ordenado en 30+ días.",
  auto_reviewRequestTitle: "Solicitud de reseña",
  auto_reviewRequestDesc:
    "Pide una reseña al cliente 1-2 días después de que su pedido fue entregado.",
  auto_trialExpiringTitle: "Trial por vencer (MENIUS)",
  auto_trialExpiringDesc:
    "Avisa al dueño cuando faltan 3 días o menos para que termine su prueba gratuita.",
  auto_setupIncompleteTitle: "Menú vacío (MENIUS)",
  auto_setupIncompleteDesc:
    "Recuerda al dueño configurar su menú si lleva 2+ días sin productos.",
  auto_noOrdersTitle: "Sin pedidos (MENIUS)",
  auto_noOrdersDesc:
    "Envía tips de marketing a restaurantes con productos pero sin pedidos en 14 días.",
  ...
  billing_subscriptionActivated:
    "Suscripción activada con éxito. Bienvenido a MENIUS.",
  billing_processCancelled:
  ...
  billing_trialDowngradeNote:
    "Al finalizar tu prueba, tu cuenta cambiará automáticamente al plan Free. Sin cobros automáticos, sin tarjeta de crédito requerida.",
  ...
  staff_noMembersDesc:
    "Invita a tu equipo para que ayuden a gestionar el restaurante.",
  ...
  data_deleteConfirmText:
    'Para confirmar, escribe <span class="font-mono font-bold">ELIMINAR</span> en el campo de abajo:',
  ...
  expired_desc:
    "Tu menú, productos y configuración están seguros. Elige un plan para seguir recibiendo pedidos y usando el dashboard.",
  expired_errorPayment: "No se pudo crear la sesión de pago. Intenta de nuevo.",
  expired_connectionError:
    "Error de conexión. Verifica tu internet e intenta de nuevo.",
  ...
  settings_installStep1:
    "Abre esta página en Safari (iPhone) o Chrome (Android / Escritorio).",
  settings_installStep2:
    "Toca el botón Compartir (iPhone), el menú ⋮ (Android) o el ícono ⊕ en la barra de direcciones (Escritorio).",
  settings_installStep3:
    'Selecciona "Agregar a pantalla de inicio" y confirma.',
...
const en: DashboardTranslations = {
  ...
  counter_hub_browserDesc:
    "Works on any phone, tablet, or computer with Chrome or Safari. No installation needed.",
  ...
  counter_hub_nativeDesc:
    "Install the app on your Android tablet. Faster, with notifications and full Bluetooth printer support.",
  ...
  counter_hub_installStep1:
    "On the Android tablet, open Chrome and go to the APK download link.",
  counter_hub_installStep2:
    'If Android asks "Install from unknown source?", accept. It\'s safe.',
  counter_hub_installStep3: "Once installed, open the MENIUS Counter app.",
  counter_hub_installStep4:
    "Sign in with your MENIUS account. The app connects automatically to your orders.",
  ...
  counter_hub_wifiNote:
    "The tablet must be connected to WiFi to receive orders in real time. For fixed counter setups, the printer can connect via Ethernet (RJ45 cable) for maximum reliability — configure it under Menu → Printer inside the app.",
  ...
  counter_hub_scanQrDesc:
    "Point your Android tablet camera at the QR code to download the app.",
  ...
  home_trialEnjoy:
    "You're trying the Starter plan for free. When it ends, you'll move to the Free plan — no charges.",
  home_trialDowngradeNote:
    "Without a subscription, you'll continue on the Free plan (free forever).",
  ...
  home_sampleMenuDesc:
    "You now have sample categories, products, and tables. Edit them from your dashboard.",
  home_readyDesc:
    "You can add products manually or load a sample menu to see how it works.",
  ...
  home_upsellDesc:
    "You're on the free plan. Accept delivery, pickup, and online payments with a paid plan.",
  ...
  orders_emptyDesc:
    "Share your QR menu with customers to start receiving orders in real time.",
  ...
  tables_noTablesDesc:
    "Create tables to generate custom QR codes that your customers scan to order.",
  ...
  tables_generalQRDesc:
    "Share this QR on social media, stickers, cards, flyers",
  ...
  editor_categoryNote:
    'Products in this category appear under "{name}" in the menu.',
  editor_aiLabel: "AI",
  ...
  categories_deleteConfirm:
    "Delete this category? All associated products will also be deleted.",
  ...
  chat_welcomeDesc:
    "Your business partner and chef consultant. Ask me about sales, customers, recipes, strategies, or how to use the dashboard.",
  ...
  chat_errorLimit:
    "You've reached the message limit. Try again in a few minutes.",
  ...
  settings_mainLanguageDesc:
    "The base language for your products and categories.",
  settings_additionalLanguages: "Additional languages",
  settings_additionalLanguagesDesc:
    "Add languages so your customers can view the menu in their language.",
  settings_primary: "primary",
  settings_addLanguage: "Add",
  settings_addLanguageSelect: "Add language...",
  settings_languageSelectorNote:
    "Your customers will see a language selector on the menu. Go to Menu → Products to add translations.",
  ...
  settings_bannerFormatNote:
    "Ideal size: 1200 x 400px (3:1). JPG, PNG or WebP, max 10MB.",
  settings_dineInDesc: "Customer orders and eats at your restaurant",
  settings_pickupDesc: "Customer orders and picks up",
  settings_deliveryDesc:
    "Customer provides their address and you deliver the order",
  settings_deliveryFeeNote:
    "Shown to customers before confirming the order. Set to 0 for free delivery.",
  settings_cashDesc:
    "Customer pays upon receiving the order or at the register",
  settings_onlinePaymentDesc:
    "Customer pays by card when ordering (requires Stripe Connect)",
  ...
  settings_whatsappOrdersDesc:
    "You will receive a WhatsApp message every time a new order comes in.",
  settings_emailNotificationLabel: "Email for business notifications",
  settings_emailNotificationDesc:
    "Customers who provide their email will receive confirmations and order updates.",
  settings_notificationsOffDesc:
    "Notifications are disabled. Enable them to receive alerts for new orders.",
  ...
  settings_dnsPropagation:
    "Add this CNAME record in your domain provider (GoDaddy, Namecheap, Cloudflare, etc.). Propagation can take up to 48 hours.",
  ...
  onboarding_allCompleteDesc:
    "You've completed all steps. Your digital menu is live.",
  ...
  onboarding_openCounterDesc:
    "Manage all your orders in real time from the Counter",
  onboarding_configurePrinter: "Configure your printer",
  onboarding_configurePrinterDesc:
    "Connect a thermal printer to print tickets automatically",
  onboarding_installPWA: "Install MENIUS on your tablet",
  onboarding_installPWADesc:
  ...
  onboarding_previewMenu: "Preview your menu",
  ...
  reviews_noReviewsDesc:
    "Reviews will appear when your customers rate their orders.",
  ...
  customers_empty:
    "No customers yet. They are created automatically with each order.",
  ...
  customers_notesPlaceholder:
    "Allergies, preferences, notes about this customer...",
  ...
  email_aiDesc:
    "AI will create optimized subject, message and CTA based on your restaurant and audience.",
  ...
  email_failed: "failed",
  email_variablesHint:
    "Use {name} to personalize with customer name, {restaurant} for your restaurant",
  email_msgVariablesHint:
    "Variables: {name}, {total_orders}, {total_spent}, {restaurant}",
  ...
  sms_serviceDesc:
    "To send SMS you need a provider like Twilio or MessageBird. Configure your credentials in environment variables. Estimated cost: $0.01-0.05 USD per SMS depending on the country.",
  ...
  auto_infoText:
    "Automations run daily at 10:00 UTC via a Vercel cron job. Real-time emails (order confirmation, alerts) are sent instantly when the event occurs. To enable/disable automations, go to <strong>Settings → Notifications</strong>.",
  ...
  auto_orderConfirmDesc:
    "Sends automatic confirmation to the customer when they place an order with their email.",
  auto_orderConfirmTrigger: "Each new order",
  auto_orderStatusTitle: "Status update",
  auto_orderStatusDesc:
    "Notifies the customer when their order status changes (confirmed, preparing, ready, delivered).",
  auto_orderStatusTrigger: "Order status change",
  auto_ownerAlertTitle: "New order alert (owner)",
  auto_ownerAlertDesc:
    "Sends notification to the restaurant owner every time a new order arrives.",
  auto_welcomeTitle: "Welcome new customers",
  auto_welcomeDesc:
    "Automatic welcome email to customers who place their first order.",
  auto_reactivationTitle: "Reactivate inactive",
  auto_reactivationDesc:
    "Invites customers who haven't ordered in 30+ days to come back.",
  auto_reviewRequestTitle: "Review request",
  auto_reviewRequestDesc:
    "Asks the customer for a review 1-2 days after their order was delivered.",
  auto_trialExpiringTitle: "Trial expiring (MENIUS)",
  auto_trialExpiringDesc:
    "Notifies the owner when 3 days or less remain in their free trial.",
  auto_setupIncompleteTitle: "Empty menu (MENIUS)",
  auto_setupIncompleteDesc:
    "Reminds the owner to set up their menu if they have had no products for 2+ days.",
  auto_noOrdersTitle: "No orders (MENIUS)",
  auto_noOrdersDesc:
    "Sends marketing tips to restaurants with products but no orders in 14 days.",
  ...
  billing_subtitle:
    "Manage your subscription, usage and payments in one place.",
  billing_subscriptionActivated:
    "Subscription activated successfully. Welcome to MENIUS.",
  billing_processCancelled:
    "The process was cancelled. You can try again anytime.",
  ...
  billing_trialDowngradeNote:
    "When your trial ends, your account will automatically switch to the Free plan. No automatic charges, no credit card required.",
  ...
  billing_upgradeDesc:
    "Compare plans and choose the one that best fits your business needs.",
  ...
  billing_choosePlan:
    "Choose a plan to start using MENIUS and digitize your restaurant.",
  ...
  data_subtitle:
    "Manage your personal data and restaurant data in accordance with GDPR and privacy laws.",
  data_exportTitle: "Export my data",
  data_exportDesc:
    "Download a complete copy of all your data: restaurant, menu, orders, customers and settings.",
  ...
  data_deleteDesc:
    "Permanently delete your account, restaurant, menu, customers and order history. This action is <strong>irreversible</strong>.",
  data_deleteButton: "Delete my account",
  data_deleteConfirmText:
    'To confirm, type <span class="font-mono font-bold">DELETE</span> in the field below:',
  data_deleting: "Deleting...",
  data_confirmDeletion: "Confirm deletion",
  data_cancelButton: "Cancel",
  data_gdprNote:
    "You have rights over your data under GDPR (General Data Protection Regulation). For more information, see our",
  ...
  expired_desc:
    "Your menu, products and settings are safe. Choose a plan to continue receiving orders and using the dashboard.",
  expired_errorPayment:
  ...
  verify_desc:
    "To access the dashboard you need to confirm your email address. Check your inbox and click the link we sent you.",
  ...
  settings_installStep1:
    "Open this page in Safari (iPhone) or Chrome (Android / Desktop).",
  settings_installStep2:
    "Tap the Share button (iPhone) or the menu ⋮ (Android) or the ⊕ icon in the address bar (Desktop).",
...
const dashboardTranslations: Record<DashboardLocale, DashboardTranslations> = {
  es,
  en,
};

export function getDashboardTranslations(
