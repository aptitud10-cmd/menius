...
const es: DashboardTranslations = {
  ...
  onboarding_allCompleteDesc: 'Tu menú digital está listo. Comparte tu QR y empieza a vender.',
  ...
  onboarding_customizeMenuDesc: 'Entre más platillos, más ventas. Agrega fotos también.',
  onboarding_generateQR: 'Crea los QR de tus mesas',
  onboarding_generateQRDesc: 'Imprímelos y ponlos en cada mesa para que los clientes pidan solos',
  onboarding_firstOrder: 'Recibe tu primer pedido',
  onboarding_firstOrderDesc: 'Comparte tu menú con un cliente y recibe tu primer orden',
  onboarding_openCounter: 'Abre la pantalla de pedidos',
  onboarding_openCounterDesc: 'Desde aquí ves y gestionas todos tus pedidos en tiempo real',
