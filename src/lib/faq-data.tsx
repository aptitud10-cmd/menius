...
const es: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: '¿MENIUS cobra comisión por pedido?', a: 'Depende del plan y del método de pago. Si tus clientes pagan en efectivo, no hay ninguna comisión de MENIUS en ningún plan. Si habilitaste pagos online con Stripe Connect, MENIUS aplica una pequeña comisión sobre esas transacciones: 2% en el plan Free, 1% en Starter, y 0% en Pro y Business. Wompi (pagos en Colombia) no tiene comisión de MENIUS.' },
      ...
      { q: '¿Qué incluye el plan gratuito?', a: 'El plan Free incluye: menú digital con QR para hasta 5 mesas, solo dine-in, hasta 50 pedidos por mes, importar menú desde foto con IA y soporte por email. No requiere tarjeta de crédito y no vence. Si habilitas pagos online, se aplica una comisión del 2% sobre esas transacciones. Los pedidos en efectivo no tienen ningún costo adicional.' },
      { q: '¿Cuáles son los planes disponibles?', a: <>Ofrecemos cuatro planes: Free ($0/mes, siempre gratis, 2% comisión en pagos online); Starter ($39/mes, 1% comisión en pagos online); Pro ($79/mes, 0% comisión); y Business ($149/mes, 0% comisión). Los pedidos en efectivo nunca tienen comisión de MENIUS en ningún plan. <Link href="/#precios" className={lnk}>Ver planes y precios →</Link></> },
