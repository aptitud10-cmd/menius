...
const es: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: '¿MENIUS cobra comisión por pedido?', a: 'Depende del plan y del método de pago. Los pedidos en efectivo no tienen comisión en ningún plan. Los pagos online con Stripe Connect tienen comisión según el plan: Starter 1%, Pro 0%, Business 0%. El plan Free no incluye pagos online. Durante los 14 días de prueba (trial) la comisión es 0%. Wompi (pagos en Colombia) no tiene comisión de MENIUS.' },
      ...
      { q: '¿Qué incluye el plan gratuito?', a: 'El plan Free incluye: menú digital con QR para hasta 5 mesas, solo dine-in, hasta 50 pedidos por mes, importar menú desde foto con IA y soporte por email. No requiere tarjeta de crédito y no vence. Los clientes pagan en efectivo — los pagos online con tarjeta están disponibles desde el plan Starter.' },
      { q: '¿Cuáles son los planes disponibles?', a: <>Ofrecemos cuatro planes: Free ($0/mes, efectivo únicamente, sin pagos online); Starter ($39/mes, pagos online con 1% comisión); Pro ($79/mes, pagos online 0% comisión); y Business ($149/mes, pagos online 0% comisión). Los pedidos en efectivo nunca tienen comisión en ningún plan. Durante el trial de 14 días, la comisión en pagos online es 0%. <Link href="/#precios" className={lnk}>Ver planes y precios →</Link></> },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Cuánto cobran Stripe y MENIUS por transacción?', a: 'Stripe cobra su tarifa estándar (generalmente 2.9% + $0.30 USD por transacción en EE.UU., varía por país). Wompi tiene sus propias tarifas según tu negociación con Bancolombia. Adicionalmente, MENIUS cobra una comisión de plataforma sobre pagos online procesados por Stripe Connect: 1% en Starter, 0% en Pro y Business. Durante el trial de 14 días la comisión es 0%. Los pagos en efectivo y por Wompi no tienen comisión de MENIUS. El plan Free no admite pagos online con tarjeta.' },
...
const en: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: 'Does MENIUS charge a commission per order?', a: 'It depends on your plan and payment method. Cash orders have zero MENIUS commission on any plan. If you enable online payments via Stripe Connect, MENIUS applies a small platform commission: 2% on the Free plan, 1% on Starter, and 0% on Pro and Business. Wompi payments (Colombia) have no MENIUS commission.' },
      ...
      { q: 'What does the free plan include?', a: 'The Free plan includes: digital menu with QR for up to 5 tables, dine-in only, up to 50 orders per month, AI menu import from photo, and email support. No credit card required and it never expires. If you enable online payments, a 2% platform commission applies to those transactions. Cash orders have no MENIUS fee on any plan.' },
      { q: 'What plans are available?', a: <>We offer four plans: Free ($0/mo, 2% commission on online payments); Starter ($39/mo, 1% commission on online payments); Pro ($79/mo, 0% commission); and Business ($149/mo, 0% commission). Cash orders have no MENIUS commission on any plan. <Link href="/#precios" className={lnk}>View plans and pricing →</Link></> },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'How much do Stripe and MENIUS charge per transaction?', a: 'Stripe charges its standard fee (generally 2.9% + $0.30 USD per transaction in the US, varies by country). Wompi has its own rates negotiated with Bancolombia. Additionally, MENIUS charges a platform commission on online payments via Stripe Connect: 2% on Free, 1% on Starter, 0% on Pro and Business. Cash and Wompi payments have no MENIUS commission.' },
