...
const es: FaqCategory[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Qué pasa después de los 14 días de prueba?', a: 'Al terminar la prueba, eliges el plan que prefieras y continúas sin interrupciones. Si no eliges un plan, tu menú público sigue activo en modo gratuito con un límite de 3 pedidos por día — suficiente para seguir operando mientras decides. Tu dashboard, datos, menú y configuración nunca se pierden. Puedes suscribirte en cualquier momento para eliminar el límite.' },
      { q: '¿Cuáles son los planes disponibles?', a: <>Ofrecemos tres planes: Starter ($39/mes) con menú digital, QR elegantes, MENIUS AI, generación de imágenes con IA y login con Google; Pro ($79/mes) con delivery, WhatsApp, cocina KDS, analytics avanzado y promociones; y Business ($149/mes) con todo ilimitado, dominio propio y soporte dedicado. Todos sin comisiones por pedido. <Link href="/#precios" className={lnk}>Ver planes y precios →</Link></> },
      ...
      { q: '¿Qué incluye el plan gratuito después del trial?', a: 'Después del período de prueba, si no eliges un plan de pago, tu menú público sigue activo de forma gratuita con un límite de 3 pedidos por día. El dashboard, MENIUS AI, todos tus productos y configuraciones se conservan intactos. Es un plan gratuito real, sin tarjeta de crédito, ideal para restaurantes que aún están evaluando la plataforma.' },
    ],
  },
  {
    id: 'pagos-clientes',
...
const en: FaqCategory[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'What happens after the 14-day trial?', a: 'When the trial ends, you choose your preferred plan and continue without interruptions. If you don\'t choose a plan, your public menu stays active in free mode with a limit of 3 orders per day — enough to keep operating while you decide. Your dashboard, data, menu, and settings are never lost. Subscribe at any time to remove the limit.' },
      { q: 'What plans are available?', a: <>We offer three plans: Starter ($39/mo) with digital menu, elegant QR codes, MENIUS AI, AI image generation, and Google login; Pro ($79/mo) with delivery, WhatsApp, kitchen KDS, advanced analytics, and promotions; and Business ($149/mo) with everything unlimited, custom domain, and dedicated support. All with zero per-order commissions. <Link href="/#precios" className={lnk}>View plans and pricing →</Link></> },
      ...
      { q: 'What does the free plan include after the trial?', a: 'After the trial period, if you don\'t choose a paid plan, your public menu stays active for free with a limit of 3 orders per day. The dashboard, MENIUS AI, all your products, and settings are preserved intact. It\'s a real free plan — no credit card required — ideal for restaurants still evaluating the platform.' },
    ],
  },
  {
    id: 'pagos-clientes',
