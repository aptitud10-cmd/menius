...
const es: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: '¿MENIUS cobra comisión por pedido?', a: 'No. Todos los planes de suscripción (Starter, Pro, Business) tienen 0% de comisión en pagos online con Stripe. Los pedidos en efectivo nunca tienen comisión. El plan Free no incluye pagos online. Wompi (pagos en Colombia) tampoco tiene comisión de MENIUS — solo pagás la tarifa estándar de Stripe o Wompi según tu país.' },
      ...
      { q: '¿Cuáles son los planes disponibles?', a: <>Ofrecemos cuatro planes: Free ($0/mes, pedidos ilimitados, solo efectivo); Starter ($39/mes, pagos online 0% comisión); Pro ($79/mes, 0% comisión); y Business ($149/mes, 0% comisión). Los pedidos en efectivo nunca tienen comisión. <Link href="/#precios" className={lnk}>Ver planes y precios →</Link></> },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Cuánto cobran Stripe y MENIUS por transacción?', a: 'Stripe cobra su tarifa estándar (generalmente 2.9% + $0.30 USD por transacción en EE.UU., varía por país). Wompi tiene sus propias tarifas según tu negociación con Bancolombia. MENIUS cobra 0% de comisión en todos los planes de suscripción (Starter, Pro, Business). Los pagos en efectivo y por Wompi no tienen comisión de MENIUS. El plan Free no admite pagos online con tarjeta.' },
...
const en: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: 'Does MENIUS charge a commission per order?', a: 'No. All subscription plans (Starter, Pro, Business) have 0% commission on online Stripe payments. Cash orders never have any commission. The Free plan does not include online payments. Wompi payments (Colombia) also have no MENIUS commission — you only pay the standard Stripe or Wompi fee based on your country.' },
      ...
      { q: 'What plans are available?', a: <>We offer four plans: Free ($0/mo, unlimited orders, cash only); Starter ($39/mo, 0% commission on online payments); Pro ($79/mo, 0% commission); and Business ($149/mo, 0% commission). Cash orders never have any commission. <Link href="/#precios" className={lnk}>View plans and pricing →</Link></> },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'How much do Stripe and MENIUS charge per transaction?', a: 'Stripe charges its standard fee (generally 2.9% + $0.30 USD per transaction in the US, varies by country). Wompi has its own rates negotiated with Bancolombia. MENIUS charges 0% commission on all subscription plans (Starter, Pro, Business). Cash and Wompi payments have no MENIUS commission. The Free plan does not support online card payments.' },
