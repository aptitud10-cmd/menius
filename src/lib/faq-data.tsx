...
const es: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '🛒',
    questions: [
      { q: '¿Cómo recibo los pedidos?', a: 'Los pedidos llegan en tiempo real a tu dashboard con un sonido de alerta. Ves un tablero Kanban donde puedes gestionar los pedidos: pendiente → preparando → listo → entregado. También puedes recibir notificaciones por email y push en todos los planes de pago.' },
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: '¿MENIUS cobra comisión por pedido?', a: 'Los pedidos en efectivo no tienen comisión en ningún plan. Los pagos online con Stripe Connect tienen 0% de comisión en todos los planes de suscripción (Starter, Pro, Business). El plan Free no incluye pagos online. También ofrecemos un Plan por Comisión ($0/mes) donde pagas 4% por cada orden online en lugar de cuota mensual. Wompi (pagos en Colombia) no tiene comisión de MENIUS.' },
      { q: '¿Puedo usar MENIUS gratis?', a: <>Sí. MENIUS tiene un plan gratuito permanente (sin límite de tiempo y sin tarjeta de crédito). Incluye menú digital con QR para hasta 5 mesas, pedidos ilimitados (dine-in y pickup), solo efectivo e importar menú desde foto con IA. También puedes explorar nuestros <Link href="/demo" className={lnk}>demos en vivo</Link> sin crear una cuenta.</> },
      { q: '¿Qué incluye el plan gratuito?', a: 'El plan Free incluye: menú digital con QR para hasta 5 mesas, dine-in y pickup, pedidos ilimitados, importar menú desde foto con IA y soporte por email. No requiere tarjeta de crédito y no vence. Los clientes pagan en efectivo — los pagos online con tarjeta están disponibles desde el plan Starter.' },
      { q: '¿Cuáles son los planes disponibles?', a: <>Ofrecemos cuatro planes: Free ($0/mes, pedidos ilimitados, solo efectivo); Starter ($39/mes, pagos online 0% comisión); Pro ($79/mes, 0% comisión); y Business ($149/mes, 0% comisión). También ofrecemos un Plan por Comisión ($0/mes, 4% por orden online). Los pedidos en efectivo nunca tienen comisión. <Link href="/#precios" className={lnk}>Ver planes y precios →</Link></> },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Cuánto cobran Stripe y MENIUS por transacción?', a: 'Stripe cobra su tarifa estándar (generalmente 2.9% + $0.30 USD por transacción en EE.UU., varía por país). Wompi tiene sus propias tarifas según tu negociación con Bancolombia. MENIUS cobra 0% de comisión en todos los planes de suscripción (Starter, Pro, Business). Si usas el Plan por Comisión, pagas 4% por orden online. Los pagos en efectivo y por Wompi no tienen comisión de MENIUS. El plan Free no admite pagos online con tarjeta.' },
  ...
  },
  {
    ...
    icon: '🔗',
    questions: [
      { q: '¿Cómo recibo notificaciones de pedidos?', a: 'MENIUS envía notificaciones de nuevos pedidos por email y notificaciones push en tu navegador. Recibes una alerta sonora en tiempo real en el dashboard cada vez que llega un pedido nuevo. No necesitas ninguna app adicional.' },
      ...
      { q: '¿MENIUS tiene CRM de clientes?', a: 'Sí. MENIUS incluye un CRM integrado que te permite ver el historial de pedidos de cada cliente, sus preferencias, frecuencia de visitas y datos de contacto. Puedes usar esta información para crear campañas de email personalizadas y fidelizar a tus clientes.' },
      ...
      { q: '¿La app del repartidor funciona sin internet?', a: 'Sí. La app del repartidor de MENIUS (PWA) tiene soporte offline completo. Si el repartidor pierde señal en un túnel o zona sin cobertura, las acciones que realice (confirmar recogida, marcar entrega, actualizar estado) se guardan automáticamente en su celular. En cuanto recupera la señal, todo se sincroniza con el servidor sin que el repartidor tenga que hacer nada. La app también puede instalarse en la pantalla de inicio del celular con un solo toque.' },
  ...
  },
  {
    ...
    icon: '📣',
    questions: [
      { q: '¿MENIUS tiene herramientas de marketing integradas?', a: 'Sí. MENIUS incluye un Marketing Hub con: Campañas de Email (newsletters y promociones), Redes Sociales con generador de posts con IA para Instagram, Facebook y TikTok, y Automatizaciones con secuencias preconfiguradas basadas en el comportamiento del cliente.' },
      ...
      { q: '¿Qué son las Automatizaciones?', a: 'Son secuencias de emails que se activan automáticamente según el comportamiento de tus clientes. MENIUS incluye automatizaciones preconfiguradas: bienvenida al cliente nuevo, reactivación de clientes inactivos, reconocimiento de clientes VIP, entre otras. Solo las activas y trabajan solas 24/7.' },
      { q: '¿Puedo enviar promociones a mis clientes?', a: 'Sí. El módulo de Campañas de Email permite enviar promociones, descuentos y novedades a tus clientes registrados. Ideal para promociones del día, happy hours, eventos especiales o comunicados. Los emails tienen diseño profesional con tu marca.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Cómo funciona el flujo de un pedido de pickup?', a: 'El cliente ordena desde tu enlace directo → llega al Counter → el encargado acepta con el tiempo estimado → la cocina prepara → marca "listo" en el KDS → el cliente recibe notificación automática por email → pasa a recoger → el encargado marca "entregado".' },
      { q: '¿Cómo funciona el flujo de un pedido de delivery?', a: 'El cliente ordena con dirección de entrega → llega al Counter → el encargado acepta (el sistema sugiere el tiempo de entrega automáticamente según la distancia) → la cocina prepara → el encargado asigna un repartidor de tu pool → el repartidor recibe un enlace para compartir su GPS → el cliente puede ver la ubicación del repartidor en tiempo real desde su página de seguimiento → el repartidor toma foto como comprobante de entrega → se marca como entregado.' },
      { q: '¿Puedo gestionar mis propios repartidores?', a: 'Sí. En Staff > Repartidores puedes agregar tu pool de repartidores con nombre y teléfono. Al asignar un delivery desde el Counter, aparece una lista para seleccionar al repartidor disponible. Al asignarlo, recibe un enlace con la dirección de entrega y un enlace de tracking para compartir su GPS en tiempo real.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: '¿Los clientes reciben confirmación de su reservación?', a: 'Por ahora el sistema envía la solicitud al restaurante y muestra un mensaje de confirmación en pantalla. La confirmación formal al cliente (por email o teléfono) la hace el equipo del restaurante manualmente después de revisar disponibilidad. Una futura versión incluirá confirmaciones automáticas por email.' },
  ...
  },
  {
    ...
    icon: '🤝',
    questions: [
      { q: '¿Qué tipo de soporte ofrecen?', a: 'Todos los planes incluyen MENIUS AI, un asistente inteligente 24/7 que responde preguntas sobre el dashboard y tu negocio al instante. Además: Plan Free tiene soporte por email. Plan Starter tiene soporte por chat. Plan Pro tiene chat prioritario 24h. Plan Business tiene account manager dedicado (chat) y tickets con SLA < 1h.' },
...
const en: FaqCategory[] = [
  ...
  },
  {
    ...
    icon: '🛒',
    questions: [
      { q: 'How do I receive orders?', a: 'Orders arrive in real time to your dashboard with an alert sound. You see a Kanban board where you can manage orders: pending → preparing → ready → delivered. You can also receive email and push notifications on all paid plans.' },
  ...
  },
  {
    ...
    icon: '💰',
    questions: [
      { q: 'Does MENIUS charge a commission per order?', a: 'Cash orders have zero MENIUS commission on any plan. Online payments via Stripe Connect have 0% commission on all subscription plans (Starter, Pro, Business). The Free plan does not include online payments. We also offer a Commission Plan ($0/month) where you pay 4% per online order instead of a monthly fee. Wompi payments (Colombia) have no MENIUS commission.' },
      { q: 'Can I use MENIUS for free?', a: <>Yes. MENIUS has a permanent free plan — no time limit and no credit card needed. It includes a digital menu with QR codes for up to 5 tables, unlimited orders (dine-in and pickup), cash only, and AI menu import from photo. You can also explore our <Link href="/demo" className={lnk}>live demos</Link> without creating an account.</> },
      { q: 'What does the free plan include?', a: 'The Free plan includes: digital menu with QR for up to 5 tables, dine-in and pickup, unlimited orders, AI menu import from photo, and email support. No credit card required and it never expires. Online card payments are available starting from the Starter plan. Cash orders have no MENIUS fee on any plan.' },
      { q: 'What plans are available?', a: <>We offer four plans: Free ($0/mo, unlimited orders, cash only); Starter ($39/mo, 0% commission on online payments); Pro ($79/mo, 0% commission); and Business ($149/mo, 0% commission). We also offer a Commission Plan ($0/mo, 4% per online order). Cash orders never have any commission. <Link href="/#precios" className={lnk}>View plans and pricing →</Link></> },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'How much do Stripe and MENIUS charge per transaction?', a: 'Stripe charges its standard fee (generally 2.9% + $0.30 USD per transaction in the US, varies by country). Wompi has its own rates negotiated with Bancolombia. MENIUS charges 0% commission on all subscription plans (Starter, Pro, Business). If you use the Commission Plan, you pay 4% per online order. Cash and Wompi payments have no MENIUS commission. The Free plan does not support online card payments.' },
  ...
  },
  {
    ...
    icon: '🔗',
    questions: [
      { q: 'How do I receive order notifications?', a: 'MENIUS sends new order notifications via email and browser push notifications. You also receive a real-time sound alert on the dashboard every time a new order comes in. No additional apps required.' },
      ...
      { q: 'Does MENIUS have a customer CRM?', a: 'Yes. MENIUS includes a built-in CRM that lets you view each customer\'s order history, preferences, visit frequency, and contact information. You can use this data to create personalized email campaigns and build customer loyalty.' },
      ...
      { q: 'Does the driver app work without internet?', a: 'Yes. The MENIUS driver app (PWA) has full offline support. If the driver loses signal in a tunnel or dead zone, any actions they take — confirming pickup, marking delivery, updating status — are automatically saved on their phone. As soon as signal returns, everything syncs to the server with no action needed from the driver. The app can also be installed on the phone\'s home screen with a single tap.' },
  ...
  },
  {
    ...
    icon: '📣',
    questions: [
      { q: 'Does MENIUS have built-in marketing tools?', a: 'Yes. MENIUS includes a Marketing Hub with: Email Campaigns (newsletters and promotions), Social Media with AI post generator for Instagram, Facebook, and TikTok, and Automations with pre-built sequences based on customer behavior.' },
      ...
      { q: 'What are Automations?', a: 'Automations are email sequences that trigger automatically based on your customers\' behavior. MENIUS includes pre-built automations: new customer welcome, inactive customer reactivation, VIP customer recognition, and more. Just activate them and they work 24/7 on their own.' },
      { q: 'Can I send promotions to my customers?', a: 'Yes. The Email Campaigns module lets you send promotions, discounts, and news to your registered customers. Ideal for daily specials, happy hours, special events, or announcements. Emails feature professional branded designs.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'How does a pickup order flow work?', a: 'Customer orders from your direct link → arrives at Counter → staff accepts with estimated time → kitchen prepares → marks "ready" on KDS → customer receives automatic email notification → customer comes to pick up → staff marks "delivered".' },
      { q: 'How does a delivery order flow work?', a: 'Customer orders with delivery address → arrives at Counter → staff accepts (system automatically suggests delivery time based on distance) → kitchen prepares → staff assigns a driver from your pool → driver receives a link with the address and GPS tracking → customer can see the driver\'s real-time location on their tracking page → driver takes a proof-of-delivery photo → order is marked as delivered.' },
      { q: 'Can I manage my own delivery drivers?', a: 'Yes. Under Staff > Drivers you can add your driver pool with name and phone number. When assigning a delivery from the Counter, a list appears to select the available driver. Once assigned, they receive a link with the delivery address and a tracking link to share their GPS location in real time.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'How does the customer CRM work?', a: 'The CRM automatically records every customer who places an order. You can see their full history, visit frequency, total spend, and the system automatically assigns tags (New, Frequent, VIP) based on their behavior. From the CRM you can contact them via email with one click.' },
    ],
  },
  {
    id: 'seguridad',
  ...
  },
  {
    ...
    icon: '🤝',
    questions: [
      { q: 'What kind of support do you offer?', a: 'All plans include MENIUS AI, an intelligent 24/7 assistant that answers questions about the dashboard and your business instantly. Additionally: Free Plan has email support. Starter Plan has chat support. Pro Plan has priority chat support 24h. Business Plan has a dedicated account manager (chat) and tickets with SLA < 1h.' },
