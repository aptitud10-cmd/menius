...
const PRICING_PLANS = [
  {
    name: 'Free',
    price: 0,
    desc: 'Para probar la herramienta',
    features: ['3 mejoras por hora', 'Todos los estilos', 'Descarga sin marca de agua'],
    cta: 'Empezar gratis',
    href: '/signup',
  },
  {
    name: 'Starter',
    price: 15,
    desc: 'Para restaurantes pequeños',
    features: ['100 mejoras al mes', 'Generación desde texto', 'Descripciones IA', 'Aplicar directo al menú', 'Soporte prioritario'],
    cta: 'Elegir Starter',
    href: '/signup',
    popular: true,
  },
  {
    ...
    features: ['500 mejoras al mes', 'Todo lo de Starter', 'Procesamiento en lote', 'API de acceso', 'Soporte dedicado'],
    cta: 'Elegir Pro',
    href: '/signup',
  },
];
