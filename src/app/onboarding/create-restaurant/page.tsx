...
const WIZARD_TEXT = {
  es: {
    ...
    planDesc: 'Tenés 14 días de Starter gratis al registrarte. Después se convierte en Free a menos que actives un plan pago.',
  ...
  en: {
    ...
    planDesc: 'You get 14 days of Starter free when you sign up. After that, it becomes Free unless you activate a paid plan.',
