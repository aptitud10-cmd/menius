...
const releases: Release[] = [
  {
    ...
    changes: [
      { type: 'new', es: 'Comisiones por transacción: MENIUS cobra una comisión sobre pagos online procesados con Stripe Connect — 2% en plan Free, 1% en Starter, 0% en Pro y Business. Los pedidos en efectivo y pagos Wompi (Colombia) no tienen comisión. Las comisiones aplican solo a cuentas nuevas.', en: 'Transaction commissions: MENIUS charges a commission on online payments via Stripe Connect — 2% on Free, 1% on Starter, 0% on Pro and Business. Cash orders and Wompi (Colombia) payments are never charged. Commissions apply to new accounts only.' },
