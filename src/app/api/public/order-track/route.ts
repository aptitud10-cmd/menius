...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Use select('*') so we never break when a column is renamed/dropped in the DB.
    // The column list also matches what the SSR page fetches, keeping shape consistent.
